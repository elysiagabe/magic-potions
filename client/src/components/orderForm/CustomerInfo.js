...
const CustomerInfo = ({ setOpenIndex, formValues, setFormValues }) => {
    ...
    return (
        <Box bg="white" mb={4} boxShadow="xs">
            <FormSectionHeader title={"Customer Information"} setOpenIndex={setOpenIndex} index={customerIndex} />
            ...
            <AccordionPanel>
                ...
                <Center pb={6}>
                    <Button onClick={handleSubmit(handleClick)}>Continue to Payment</Button>
                </Center>
